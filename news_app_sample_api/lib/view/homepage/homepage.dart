...
import 'package:news_app_sample_api/dummydb.dart';
import 'package:news_app_sample_api/view/articledetailscreen/articledetail.dart';
import 'package:news_app_sample_api/view/globalwidget/categorydetailpage.dart';
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => CategoryDetailPage(
                                categoryName: Dummydb.categories[index],
                ...
                // News Section (Filtered based on the search query)
                Padding(
                  padding: const EdgeInsets.all(8.0),
                ...
                // Regular News List Section (Filtered based on the search query)
                Padding(
                  padding: const EdgeInsets.all(8.0),
